...
builder.Services.Configure<JiraSettings>(builder.Configuration.GetSection(nameof(JiraSettings)));
...
builder.Services
    ...
    .AddScoped<IJiraTicketRepository, JiraTicketRepository>()
    .AddScoped<IJiraTicketService, JiraTicketService>()
    .AddScoped<IJiraClientService, JiraClientService>();
